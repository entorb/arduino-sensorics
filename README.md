...
* Standalone CO2 traffic light for our kindergarten and school
  * offline
  * in proper case
...
CO2 Traffic Light V1.2: Mass production and added history bar chart via OLED display ([Bauanleitung](https://github.com/entorb/arduino-sensorics/blob/main/CO2-Ampel-Bauanleitung.md))
